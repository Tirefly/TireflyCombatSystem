...
/**
 * Skill Modifier Def 资产创建工厂。
 */
UCLASS()
class TIREFLYCOMBATSYSTEMEDITOR_API UTcsSkillModifierDefinitionFactory : public UFactory
{
	GENERATED_BODY()

public:
	UTcsSkillModifierDefinitionFactory();
 ...
 */
UCLASS()
class TIREFLYCOMBATSYSTEMEDITOR_API UTcsSkillDefinitionFactory : public UFactory
{
	GENERATED_BODY()

public:
	UTcsSkillDefinitionFactory();
