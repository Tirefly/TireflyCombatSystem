...
> **历史注释 (2026-06-08)**：本 spec 中列出的 `CreateAttributeModifierWithOperands` 已由 `add-modifier-bindings-api-and-task` 提案删除，替换为 `CreateAttributeModifierWithBindings`。归档时保留原始内容作为历史记录。
>
