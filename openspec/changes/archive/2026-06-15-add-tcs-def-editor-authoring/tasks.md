...
- [x] 3.4 将 `UTcsSkillModifierDefinition` 纳入编辑器 authoring flow（UFactory + UAssetDefinitionDefault + PrimaryAssetType 勘误校验）。
- [x] 3.5 将 `UTcsSkillDefinition` 纳入编辑器 authoring flow（UFactory + UAssetDefinitionDefault；路径勘误沿用 StateDef）。
