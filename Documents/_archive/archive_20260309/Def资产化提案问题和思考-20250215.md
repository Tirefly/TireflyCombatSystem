...
- AttributeManagerSubsystem 确实很有必要在初始化的时候就加载并注册所有的 AttributeDefs，StateManagerSubsystem 确实也很有必要在初始化的时候就加载并注册所有的 StateSlotDefs。但是 StateManagerSubsystem 是否有必要在初始化的时候就加载并注册所有的 StateDefs，我觉得是个值得讨论和商榷的问题
